...
public class Controller {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "데이터 삽입 성공", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "500", description = "데이터 삽입 문제 발생", content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "400", description = "handle Validation Exception -> 유효성 오류", content = @Content(mediaType = "application/json"))
    })
